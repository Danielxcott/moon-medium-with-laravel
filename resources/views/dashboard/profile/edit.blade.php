...
<section class="profile-content create-form-wrapper">
    <form action="{{ route("update.profile",$user->username) }}"  id="edit-profile" method="POST" enctype="multipart/form-data">
        @csrf
        @method("put")
    </form>
        ...
        <div class="profile-head">
            <div class="profile-pic edit-profile-pic">
                ...
                <div class="edit-profile-photo">
                    <input type="file"  id="profile-input" name="profile" form="edit-profile" class="d-none">
